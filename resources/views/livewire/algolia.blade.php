<div>
  ...
  <div class="pt-2 relative mx-auto text-gray-600">
    <input class="border-2 border-gray-300 bg-white h-10 px-5 pr-16 rounded-lg text-sm focus:outline-none w-full"
      type="search" name="search" wire:model="search" placeholder="Search scope is limited to current team">
  ...
  <div class="mb-2 mt-4">
    ...
    <div><span class="text-gray-400 text-sm">Author:</span>
  ...
  <div class="mb-2 mt-2">
    @if(count($results['recipes']) > 0)
    @foreach($results['recipes'] as $recipe)
    <div><span class="text-gray-400 text-sm">Recipe:</span>

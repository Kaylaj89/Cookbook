<div>
    ...
    <main class="">
        <!-- file upload modal -->
        <article aria-label="File Upload Modal" class="" ondrop="dropHandler(event);"
            ondragover="dragOverHandler(event);" ondragleave="dragLeaveHandler(event);"
            ondragenter="dragEnterHandler(event);">
            <!-- overlay -->
            <div id="overlay"
                class="w-full h-full absolute top-0 left-0 pointer-events-none flex flex-col items-center justify-center rounded-md">
                <i>
            ...
            <section class="h-full w-full h-full flex flex-col">
                <header
                    class="border-dashed border-2 border-gray-300 py-12 flex flex-col justify-center items-center rounded-md">
                    <p class="mb-3 font-semibold text-gray-900 flex flex-wrap justify-center">
                        <span>Drag and drop your</span>&nbsp;<span>files anywhere or</span>
                    </p>
                    <input id="hidden-input" type="file" name="{{$name}}" multiple class="hidden"
                        accept="{{$accept}}" />
                    <span style="cursor:pointer;" id="button"
            ...
            <footer class="flex justify-end px-8 pb-8 pt-4">
                ...
                <span id="cancel" style="cursor: pointer;"
                    class="ml-3 rounded-sm px-3 py-1 bg-gray-200 hover:bg-gray-300 focus:shadow-outline focus:outline-none">
                    Cancel
                </span>
            </footer>
        </article>
